...
const CATEGORIES: Category[] = [
  ...
  { key: '土壌構造', label: '土壌構造・物理性（硬度・粒度・礫密度）' },
  { key: '排水詳細', label: '排水・水文（滞水・侵食・暗渠）' },
  { key: '有機物', label: '有機物・生物性（残渣・生物活動痕）' },
  { key: '土地利用履歴', label: '土地利用履歴（畝跡・過去の用途）' },
  { key: '雑草植生', label: '雑草・植生（優占種・被覆率・樹木化）' },
  { key: '周辺環境', label: '周辺環境（建物・日照）' },
  { key: '微気候', label: '微気候（風当たり・防風林・霜害リスク）' },
  { key: '災害リスク', label: '災害リスク（侵食・獣害・水害）' },
  { key: '再生コスト', label: '再生コスト（除去物・整地・畦畔）' },
